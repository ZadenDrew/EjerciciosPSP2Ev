...
public class Calculadora extends javax.swing.JFrame {
    ...
    String op;
    static Socket clienteSocket;//cliente
    static InputStream is;//recibe información
    static OutputStream os;//envía información
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelOperaciones, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        try {
            String[] mens = pantalla.getText().trim().split(" ");
            String mensaje = pantalla.getText();
            if (mens.length != 2) {
                JOptionPane.showMessageDialog(null, "Ingrese operandos y operador separados por espacio");
            } else {
...
////        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            clienteSocket = new Socket("127.0.0.1", 666);

            is = clienteSocket.getInputStream();//
            os = clienteSocket.getOutputStream();//petición envio de mensaje del cliente
            String msg = "";
            while (!msg.equalsIgnoreCase("** APAGADA **")) {
                msg = is.read();
                pantalla.setText(pantalla.getText().trim() + "resultado" + msg);
            }
        } catch (Exception e) {
        }
    }
